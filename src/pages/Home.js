...
const Home = () => {
  ...
  <div className='line'></div>
  <img className= 'two' src={kartagraficzna} alt="MM project " />
  <div className='line'></div>
   ...
   <div className="middle">
    <p className="text">Github Portolio</p>
        ...
        <iframe title="vimeo-player" src="https://player.vimeo.com/video/683784317?h=b5fe1a48f4" width="640" height="376" frameborder="0" allowfullscreen></iframe>
       <a href="https://xd.adobe.com/view/b1606310-ec8b-4c9c-931e-65b1740f4e6b-e433/">CLICK</a>
   <div className='line'></div>
